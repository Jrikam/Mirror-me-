...
$all_objectifs = $stmt->fetchAll(PDO::FETCH_ASSOC);    
...
<head>    
    <meta charset="UTF-8">    
    <title>Objectif Mirror Me</title>    
    <style>    
...
<form method="post" action="save_objectifs.php">    
    <div class="objectifs">    
        <?php foreach ($generated_objectifs as $obj): ?>    
            <div class="objectif">    
                <label>    
                    <input type="checkbox" name="objectifs[]"     
                           value="<?= $obj['id'] ?>"     
                           <?= in_array($obj['id'], $checked_objectifs) ? 'checked' : '' ?>>    
